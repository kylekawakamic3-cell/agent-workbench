...
function ModelLogo({
  ...
  return (
    <span
      ...
      style={{ background: bg }}
    >
      <svg viewBox="0 0 24 24" className="w-3 h-3" fill="#fff" aria-hidden>
        {provider === "openai" ? (
          ...
          <path d="M12 2 C 12 12 12 12 22 12 C 12 12 12 12 12 22 C 12 12 12 12 2 12 C 12 12 12 12 12 2 Z" />
        ) : (
          ...
          Array.from({ length: 12 }).map((_, i) => {
            ...
            const inner = 0.6;
            const outer = 11.5;
            const wIn = 2.9; // half-width near center
            const cx = 12;
            const cy = 12;
